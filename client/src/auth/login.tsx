...
import {Avatar, Box, Button, Grid, InputAdornment, OutlinedInput, Paper, TextField} from "@mui/material";
        ...
        <div>
            <Grid>
                <Paper elevation={10} style={paperStyle}>
                    ...
                    {loginSuccessful && <div style={{fontFamily:"sans-serif",display: "flex",  justifyContent:"center", alignItems:"center", marginTop:"20px", color:"green"}}> Logged in successfully </div>}
                </Paper>
            </Grid>
        </div>
    );
